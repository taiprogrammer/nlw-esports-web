...
function PublishAds() {
    return (
        ...
        <div className="pt-1 bg-nlw-gradient rounded-lg self-stretch">
          ...
          >
            <div>
              <h2 className="text-2xl text-white font-black">Não encontrou seu duo?</h2>
              <p className="text-base font-normal text-zinc-400">Publique um anúncio para encontrar novos players!</p>
            </div>
            <div>
